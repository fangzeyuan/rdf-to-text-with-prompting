...
if 'e2e' in opt.train_data_file:
    ...
    output_path = "data/e2e_data/generated_src1_train_paraphrased_t5_"+str(opt.num_return_sequences)+".csv"
    ...
    output_path = "data/DART/generated_dart_paraphrased_full_train_t5_"+str(opt.num_return_sequences)+".csv"
    ...
    output_path = "data/webnlg_challenge_2017/generated_train_paraphrased_t5_" + str(opt.num_return_sequences) + ".csv"
...
for batch in tqdm(test_dataloader, desc="Testing"):
    ...
    sample = samples[0]
    labels = samples[1]
    text = ["paraphrase: " +labels[i]+ " </s>" for i in range(len(labels))]
